...
import mahyco.mipl.nxg.view.fieldreport.FieldVisitFirst;
import mahyco.mipl.nxg.view.fieldreport.FieldVisitFourth;
import mahyco.mipl.nxg.view.fieldreport.FieldVisitSecond;
import mahyco.mipl.nxg.view.fieldreport.FieldVisitThird;
import mahyco.mipl.nxg.view.fieldreport.OptionalVisit;

public class FieldReceiptDashboard extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Receipt Dashboard");
        mContext = FieldReceiptDashboard.this;
        ...
        startActivity(new Intent(mContext,CreateReceipt.class));
