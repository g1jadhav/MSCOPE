...
import mahyco.mipl.nxg.adapter.ReceiptGrowerAdapter;
...
import mahyco.mipl.nxg.view.fieldreport.FieldMonitoringReportAdapter;
import mahyco.mipl.nxg.view.fieldreport.FiledReportDashboard;
import mahyco.mipl.nxg.view.fieldreport.RecyclerViewClickListener;

public class ReceiptGrowerSelectionActivity extends BaseActivity implements RecyclerViewClickListener,
    ...
    ReceiptGrowerAdapter visitGrowerAdapter;
    ...
    protected void init() {
        try {
            ...
            mToolbar.setTitle("Seed Receipt Grower");
...
//                        result);
    ...
    public void show_grower_list() {
        try {
            ...
            try {
                visitGrowerAdapter = new ReceiptGrowerAdapter((ArrayList) mGrowerList, mContext);
