...
public class Spinner6Adapter extends ArrayAdapter<CategoryChildModel> {

    LayoutInflater flater;
    List<CategoryChildModel> list;

    public Spinner6Adapter(Context context, int resouceId, List<CategoryChildModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        Spinner6Adapter.viewHolder holder;
        View rowViews = convertView;
        if (rowViews == null) {

            holder = new Spinner6Adapter.viewHolder();
            ...
            holder = (Spinner6Adapter.viewHolder) rowViews.getTag();
        }
