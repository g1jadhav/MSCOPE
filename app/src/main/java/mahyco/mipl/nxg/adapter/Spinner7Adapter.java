...
public class Spinner7Adapter extends ArrayAdapter<CategoryChildModel> {

    LayoutInflater flater;
    List<CategoryChildModel> list;

    public Spinner7Adapter(Context context, int resouceId, List<CategoryChildModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        Spinner7Adapter.viewHolder holder;
        View rowViews = convertView;
        if (rowViews == null) {

            holder = new Spinner7Adapter.viewHolder();
            ...
            holder = (Spinner7Adapter.viewHolder) rowViews.getTag();
        }
