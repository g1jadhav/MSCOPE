...
public class SeedBatchNoFemaleAdapter extends ArrayAdapter<SeedBatchNoModel> {

    LayoutInflater flater;
    List<SeedBatchNoModel> list;

    public SeedBatchNoFemaleAdapter(Context context, int resouceId, List<SeedBatchNoModel> list) {
