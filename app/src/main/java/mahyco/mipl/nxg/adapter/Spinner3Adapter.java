...
public class Spinner3Adapter extends ArrayAdapter<CategoryChildModel> {

    LayoutInflater flater;
    List<CategoryChildModel> list;

    public Spinner3Adapter(Context context, int resouceId, List<CategoryChildModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        Spinner3Adapter.viewHolder holder;
        View rowViews = convertView;
        if (rowViews == null) {

            holder = new Spinner3Adapter.viewHolder();
            ...
            holder = (Spinner3Adapter.viewHolder) rowViews.getTag();
        }
