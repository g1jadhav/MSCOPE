...
public class Spinner4Adapter extends ArrayAdapter<CategoryChildModel> {

    LayoutInflater flater;
    List<CategoryChildModel> list;

    public Spinner4Adapter(Context context, int resouceId, List<CategoryChildModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        Spinner4Adapter.viewHolder holder;
        View rowViews = convertView;
        if (rowViews == null) {

            holder = new Spinner4Adapter.viewHolder();
            ...
            holder = (Spinner4Adapter.viewHolder) rowViews.getTag();
        }
