...
public class Spinner8Adapter extends ArrayAdapter<CategoryChildModel> {

    LayoutInflater flater;
    List<CategoryChildModel> list;

    public Spinner8Adapter(Context context, int resouceId, List<CategoryChildModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        Spinner8Adapter.viewHolder holder;
        View rowViews = convertView;
        if (rowViews == null) {

            holder = new Spinner8Adapter.viewHolder();
            ...
            holder = (Spinner8Adapter.viewHolder) rowViews.getTag();
        }
