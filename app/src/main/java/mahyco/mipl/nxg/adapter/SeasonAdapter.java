...
public class SeasonAdapter extends ArrayAdapter<SeasonModel> {

    LayoutInflater flater;
    List<SeasonModel> list;

    public SeasonAdapter(Context context, int resouceId, List<SeasonModel> list) {
    ...
    private View rowView(View convertView, int position) {
        ...
        SeasonModel rowItem = getItem(position);
        ...
        holder.txtTitle.setText(rowItem.getSeason());
