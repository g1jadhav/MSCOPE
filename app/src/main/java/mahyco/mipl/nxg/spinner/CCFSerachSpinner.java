...
public class CCFSerachSpinner extends androidx.appcompat.widget.AppCompatSpinner implements View.OnTouchListener,
        CCFSearchableDialog.SearchableItem {
    ...
    private List _items;
    private CCFSearchableDialog _searchableListDialog;
    ...
    public CCFSerachSpinner(Context context) {
        super(context);
        this._context = context;
        init();
    }

    public CCFSerachSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        this._context = context;
    ...
    public CCFSerachSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        ...
        _searchableListDialog = CCFSearchableDialog.newInstance
                (_items);
...
//
    ...
    public void onSearchableItemClicked(Object item, int position) {
        ...
        //   Toast.makeText(getContext(), "You selected " + _items.get(position), Toast.LENGTH_LONG).show();
